...
static constexpr const char* pypilot_original_names[] = {
...
static constexpr size_t pypilot_original_names_size =
    sizeof(pypilot_original_names) / sizeof(pypilot_original_names[0]);
